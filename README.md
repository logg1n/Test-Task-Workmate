...
![Добавление нового отчёта](docs/добавление%20нового%20отчета.gif)

### Прогон тестов
![Тестирование](docs/тесты.png)
...
- реализованы магические методы: 
  ...
  - `__getitem__(self, key: Union[int, str]) -> List[Any]`
  - `__bool__() -> bool` - проверяет на пустые данные в таблице, кроме headers
